...
class AssessmentViewSet(viewsets.ModelViewSet):
    ...
    print('enter AssessmentViewSet')

    def save_to_drive(self, media=None, metadata=None):
        print('enter save to drive')
    ...
    def perform_create(self, serializer):
        ...
        ori=1
        try:
            ori = Image.open(io.BytesIO(file))._getexif()[274]
        except:
            pass
        print(ori)
        ...
        # try:
        notes, processed_image, shape_image = processors[image_aspect](image, image_type, ori)
