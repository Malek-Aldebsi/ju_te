...
export const upload = ({ aspect, type, image }) => dispatch => {
  //waiting for response
  dispatch({ type: UPLOAD_LOADING })

  var formData = new FormData()
  formData.set('image_aspect', aspect)
  formData.set('image_type', type)
  formData.set('original_image', image)
...
export const delete_current = should_remove_current_assessment => (
  dispatch,
  getState
) => {
